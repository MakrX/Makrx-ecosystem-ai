        ...
        <div className="text-center max-w-4xl mx-auto">
          ...
          <div className="mb-12">
            ...
            <p className="text-xl text-white/90 mb-8 leading-relaxed max-w-3xl mx-auto">
              Discover workshops, meetups, and maker gatherings happening across India.
              Connect with fellow creators, learn new skills, and build amazing projects together.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-6 mb-12">
            <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20">
              ...
              <h3 className="text-white font-semibold text-lg mb-2">Community Meetups</h3>
              <p className="text-white/80 text-sm">Join maker meetups in your city and connect with like-minded creators</p>
            </div>
            <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20">
              <Clock className="w-8 h-8 text-makrx-yellow mb-4 mx-auto" />
              <h3 className="text-white font-semibold text-lg mb-2">Workshops</h3>
              <p className="text-white/80 text-sm">Learn new skills through hands-on workshops led by industry experts</p>
            </div>
            <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20">
              <MapPin className="w-8 h-8 text-makrx-yellow mb-4 mx-auto" />
              <h3 className="text-white font-semibold text-lg mb-2">Nationwide</h3>
              <p className="text-white/80 text-sm">Events happening across 25+ cities in India</p>
            </div>
          </div>
          ...
          <div className="bg-white/10 backdrop-blur-sm rounded-3xl p-8 border border-white/20 mb-8">
            ...
            <p className="text-white/80 mb-6 text-lg">
              Explore upcoming events, register for workshops, and connect with makers in your area.
            </p>
            <a
          ...
          <div className="text-white/70 text-sm">
            <p>
              Visit our dedicated events platform to discover all upcoming activities,
              register for workshops, and stay updated with the latest maker community news.
            </p>
          </div>
        </div>
      </div>
