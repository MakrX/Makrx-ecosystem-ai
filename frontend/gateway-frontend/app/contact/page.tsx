...
export const metadata: Metadata = {
  ...
  description: 'Get in touch with MakrX team for support, partnerships, or inquiries. Multiple ways to reach us including email, phone, and social media.',
  keywords: ['contact makrx', 'customer support', 'maker community support', 'business inquiries', 'partnership'],
  openGraph: {
    title: 'Contact MakrX - Get Support & Connect With Our Team',
