...
export const metadata: Metadata = {
  ...
  description: 'Learn about MakrX\'s mission to democratize manufacturing in India. Discover our journey, values, and commitment to empowering creators across the country.',
  keywords: ['about makrx', 'maker ecosystem india', 'digital manufacturing', 'company mission', 'maker community'],
  openGraph: {
    title: 'About MakrX - India\'s Leading Maker Ecosystem',
