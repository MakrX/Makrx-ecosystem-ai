...
export const metadata: Metadata = {
  ...
  description: 'Connect with verified manufacturing service providers across India. Find experts for 3D printing, CNC machining, PCB assembly, and custom fabrication.',
  keywords: ['service providers', 'manufacturing partners', '3d printing services', 'cnc machining', 'pcb assembly', 'custom fabrication'],
  openGraph: {
...
export default function ServiceProvidersPage() {
  return (
    <>
      <SEOStructuredData type="website" data={{ title: 'Service Providers', description: 'Professional manufacturing service providers' }} />
      <ServiceProviders />
    </>
  );
}
