...
import {
  Sun, Moon, Monitor, Star, Heart, CheckCircle, AlertTriangle,
  Info, XCircle, Zap, Palette, Settings, User, Mail, Phone, Globe
} from "lucide-react";
    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 transition-colors">
      <div className="max-w-7xl mx-auto px-4 py-8">
            ...
            <section>
              ...
              <div className="space-y-4">
                <div className="flex items-center gap-3 p-4 bg-blue-50 dark:bg-blue-900/30 border border-blue-200 dark:border-blue-800 rounded-lg">
                  ...
                  <Text variant="body" className="text-blue-800 dark:text-blue-300">
                ...
                <div className="flex items-center gap-3 p-4 bg-green-50 dark:bg-green-900/30 border border-green-200 dark:border-green-800 rounded-lg">
                  ...
                  <Text variant="body" className="text-green-800 dark:text-green-300">
                ...
                <div className="flex items-center gap-3 p-4 bg-yellow-50 dark:bg-yellow-900/30 border border-yellow-200 dark:border-yellow-800 rounded-lg">
                  ...
                  <Text variant="body" className="text-yellow-800 dark:text-yellow-300">
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
                {colorPalette.map((color) => (
                  <div key={color.name} className="group">
                    <div className={`w-full h-20 rounded-lg mb-2 ${color.class} border border-gray-200 dark:border-gray-700`} />
        ...
        {selectedTab === "typography" && (
          <div className="space-y-8">
            <section>
              <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-6">Typography Scale</h2>
        ...
        {selectedTab === "icons" && (
          <div className="space-y-8">
            <section>
              <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-6">Lucide Icons</h2>
              <div className="grid grid-cols-4 md:grid-cols-6 lg:grid-cols-8 gap-6">
                {[
                  ...
                  { icon: <CheckCircle className="w-6 h-6" />, name: "CheckCircle" },
                  ...
                  <div key={item.name} className="flex flex-col items-center p-4 bg-white dark:bg-gray-800 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors">
