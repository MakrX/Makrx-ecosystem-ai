  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      <div className="max-w-4xl mx-auto px-6 py-12">
        {/* Quick Summary */}
        <div className="bg-blue-50 dark:bg-blue-900/30 border border-blue-200 dark:border-blue-700 rounded-xl p-6 mb-8">
          <h2 className="text-xl font-bold text-blue-900 dark:text-blue-300 mb-4 flex items-center">
            <Eye className="w-5 h-5 mr-2" />
            Privacy at a Glance
          </h2>
          <div className="grid md:grid-cols-2 gap-4 text-sm">
            <div>
              <h3 className="font-semibold text-blue-800 dark:text-blue-300 mb-2">What we collect:</h3>
            ...
            <div>
              <h3 className="font-semibold text-blue-800 dark:text-blue-300 mb-2">How we protect it:</h3>
              <ul className="text-blue-700 dark:text-blue-400 space-y-1">
        ...
        <div className="prose prose-lg dark:prose-invert max-w-none">
          ...
          <section className="mb-8">
            ...
            <h3 className="text-xl font-semibold text-gray-800 dark:text-gray-200 mb-3">2.3 Project and Content Data</h3>
          ...
          <section className="mb-8">
            ...
            <div className="bg-gray-50 dark:bg-gray-800 rounded-lg p-6">
              <h3 className="text-lg font-semibold text-gray-800 dark:text-gray-200 mb-3">Legitimate Purposes:</h3>
          ...
          <section className="mb-8">
            ...
            <h3 className="text-xl font-semibold text-gray-800 dark:text-gray-200 mb-3">We may share information with:</h3>
            <ul className="list-disc pl-6 text-gray-700 dark:text-gray-300 space-y-1">
          ...
          <section className="mb-8">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div className="bg-green-50 dark:bg-green-900/30 rounded-lg p-4">
                <h3 className="font-semibold text-green-800 dark:text-green-300 mb-2">Technical Safeguards</h3>
              ...
              <div className="bg-blue-50 dark:bg-blue-900/30 rounded-lg p-4">
                <h3 className="font-semibold text-blue-800 dark:text-blue-300 mb-2">Organizational Safeguards</h3>
          ...
          <section className="mb-8">
            ...
            <div className="bg-yellow-50 dark:bg-yellow-900/30 border border-yellow-200 dark:border-yellow-700 rounded-lg p-6">
              <h3 className="text-lg font-semibold text-yellow-800 dark:text-yellow-300 mb-3">Under DPDP Act 2023 and GDPR, you have the right to:</h3>
