  ...
  <div className="bg-white dark:bg-slate-800 rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-100 dark:border-slate-700 group hover:scale-105">
    ...
    {isExternal ? (
      <a
        ...
        className={`w-full bg-${color} hover:bg-${color}/90 text-white py-3 px-6 rounded-lg transition-colors flex items-center justify-center gap-2 group`}
      >
        {cta}
        ...
        <div className="mb-16">
          ...
          <div className="flex flex-col md:flex-row items-center justify-center gap-8 mb-8">
            ...
            <div className="flex items-center gap-4">
              ...
              <span className="font-medium text-gray-900 dark:text-white">Learn & Iterate</span>
            </div>
          </div>
        </div>
