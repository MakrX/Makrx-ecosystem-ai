...
import { MapPin, Clock, DollarSign, Users, Heart, Zap, Code, Coffee, Star, Globe } from 'lucide-react';
...
export default function Careers() {
  ...
  const benefits = [
    ...
    },
    {
      ...
      description: "Hybrid work options with modern office spaces and home office allowances."
    },
    {
    ...
    },
    {
      ...
      title: "Equity & Impact",
      description: "Stock options, competitive salary, and the chance to revolutionize digital manufacturing."
    }
  ];
  ...
  const values = [
    {
      ...
      description: "We push boundaries and think differently about manufacturing and maker tools."
    },
    {
      title: "Community Driven",
      description: "Everything we build serves our community of makers, educators, and creators."
    },
    {
      title: "Quality Matters",
      description: "We take pride in delivering excellent products and exceptional experiences."
    },
    {
      title: "Inclusive Growth",
      description: "We believe in diversity, equity, and creating opportunities for everyone."
    }
  ];
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
        ...
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {values.map((value, index) => (
              <div key={index} className="p-8 bg-gray-50 dark:bg-gray-700 rounded-2xl">
      ...
      <section className="py-20">
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-4">Why Join MakrX?</h2>
            <p className="text-xl text-gray-600 dark:text-gray-300">
      ...
      <section id="open-roles" className="py-20 bg-white dark:bg-gray-800">
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="space-y-6">
            {openRoles.map((role) => (
              <div key={role.id} className="p-8 bg-gray-50 dark:bg-gray-700 rounded-2xl border border-gray-200 dark:border-gray-600 hover:border-makrx-blue dark:hover:border-makrx-yellow transition-colors">
      ...
      <section className="py-20 bg-makrx-blue dark:bg-gray-900">
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <p className="text-xl text-white/90 mb-8">
            Join a team that's building the infrastructure for the next generation of makers and creators.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              href="/contact"
