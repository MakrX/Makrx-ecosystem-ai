            ...
            <section className="relative py-24 bg-gradient-to-br from-makrx-blue via-makrx-blue/90 to-purple-900">
                <div className="max-w-7xl mx-auto px-6 text-center">
                    ...
                    <p className="text-xl md:text-2xl text-white/90 mb-8 max-w-3xl mx-auto">
                        ...
                        you succeed in your maker journey.
                    </p>
                </div>
            </section>
            ...
            <section className="py-20 -mt-12 relative z-10">
                <div className="max-w-7xl mx-auto px-6">
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                        <ContactCard
                            icon={
                                <Mail className="w-8 h-8 text-makrx-blue dark:text-makrx-yellow" />
                            }
                        ...
                        <ContactCard
                            icon={
                                <HelpCircle className="w-8 h-8 text-makrx-blue dark:text-makrx-yellow" />
                            }
                        ...
                        <ContactCard
                            icon={
                                <Building2 className="w-8 h-8 text-makrx-blue dark:text-makrx-yellow" />
                            }
                            title="Partnership"
                        ...
                        <ContactCard
                            icon={
                                <Phone className="w-8 h-8 text-makrx-blue dark:text-makrx-yellow" />
                            }
                            title="Call Us"
                ...
                <div className="max-w-4xl mx-auto px-6">
                    ...
                    {isSubmitted ? (
                            ...
                            <button
                                ...
                                onClick={() => {
                                    toast({
                                        ...
                                        description:
                                            'This is a test toast to verify the functionality is working properly.',
                                    });
                                }}
                        ...
                        <form
                            ...
                            className="bg-white dark:bg-slate-800 rounded-2xl shadow-xl border border-gray-100 dark:border-slate-700 p-8"
                        >
                                ...
                                <div className="space-y-4">
                                    ...
                                    <div className="flex items-center">
                                        ...
                                        <a
                                            ...
                                            className="text-gray-700 dark:text-gray-300 hover:text-makrx-blue dark:hover:text-makrx-yellow transition-colors"
                                        >
                                            {office.phone}
                                        </a>
                                    </div>
