...
import { ExternalLink, Upload, FileText, Calculator, Printer, Package, Truck, Zap } from 'lucide-react';
        ...
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-4 gap-8">
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold mb-3 text-gray-900 dark:text-white">Upload File</h3>
              <p className="text-gray-600 dark:text-gray-300">Drop your STL, OBJ, or other 3D files directly into our platform.</p>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold mb-3 text-gray-900 dark:text-white">Specify Details</h3>
              <p className="text-gray-600 dark:text-gray-300">Choose materials, finish options, and quantity requirements.</p>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold mb-3 text-gray-900 dark:text-white">Get Quote</h3>
              <p className="text-gray-600 dark:text-gray-300">Receive instant pricing from our network of verified manufacturers.</p>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold mb-3 text-gray-900 dark:text-white">Receive Parts</h3>
              <p className="text-gray-600 dark:text-gray-300">Your custom parts delivered directly to your doorstep.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-makrx-blue dark:bg-gray-800">
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <p className="text-xl text-white/90 mb-8">
            Join thousands of makers, engineers, and designers who trust us with their custom manufacturing needs.
          </p>
