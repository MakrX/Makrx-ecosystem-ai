  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {contactOptions.map((option, index) => (
              <div key={index} className="bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-lg text-center hover:shadow-xl transition-shadow">
                ...
                <p className="text-xs text-gray-500 dark:text-gray-400 mb-4">{option.available}</p>
      ...
      <section className="py-20 bg-white dark:bg-gray-800">
        <div className="max-w-6xl mx-auto px-6">
          <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-12 text-center">Popular Help Articles</h2>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {filteredArticles.slice(0, 6).map((article, index) => (
              ...
              >
                ...
                <span className="text-xs text-makrx-blue dark:text-makrx-yellow font-medium">{article.category}</span>
              </Link>
            ))}
          </div>
        </div>
              ...
              <div key={index} className="bg-white dark:bg-gray-800 rounded-2xl shadow-md overflow-hidden">
                ...
                >
                  <div>
                    ...
                    <span className="text-sm text-makrx-blue dark:text-makrx-yellow">{faq.category}</span>
                  </div>
                  {expandedFAQ === index ? (
      ...
      <section className="py-20 bg-white dark:bg-gray-800">
        <div className="max-w-4xl mx-auto px-6">
          ...
          <form onSubmit={handleContactSubmit} className="bg-gray-50 dark:bg-gray-700 rounded-2xl p-8">
