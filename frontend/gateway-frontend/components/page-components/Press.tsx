...
• Funding: Series A ($5M)`;
  ...
  const handleCopyBoilerplate = async () => {
    try {
      await navigator.clipboard.writeText(companyBoilerplate);
              ...
              <div key={index} className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-md hover:shadow-lg transition-shadow">
                <div className="flex flex-col md:flex-row md:items-center justify-between">
                  ...
                  <div className="md:ml-8">
                    <a
                      href={mention.url}
                      className="inline-flex items-center gap-2 px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg font-medium hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors text-gray-700 dark:text-gray-300"
                    >
                      Read Article
