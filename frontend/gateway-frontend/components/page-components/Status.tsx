      ...
      setIncidents([
        {
          ...
          status: 'resolved',
          severity: 'minor',
          description: 'Implemented enhanced rate limiting to improve API stability during peak hours.',
          startTime: '2024-01-18T10:30:00Z',
          resolvedTime: '2024-01-18T11:45:00Z',
          updates: [
            {
              time: '2024-01-18T11:45:00Z',
              message: 'Rate limiting has been successfully implemented. All services are operating normally.',
              status: 'resolved'
            },
            {
              time: '2024-01-18T11:15:00Z',
              message: 'Deployment in progress. Some users may experience brief slowdowns.',
              status: 'monitoring'
            },
            {
              time: '2024-01-18T10:30:00Z',
              message: 'Starting deployment of new rate limiting system to improve API stability.',
              status: 'identified'
            }
          ]
        }
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
        ...
        <div className="max-w-6xl mx-auto px-6 text-center">
          ...
          <div className="inline-flex items-center gap-2 px-6 py-3 bg-white/10 rounded-lg backdrop-blur-sm">
            ...
            <span className="text-white">
              All systems operational • Last updated: {new Date(lastUpdated).toLocaleTimeString()}
            </span>
          </div>
        </div>
      </section>
                ...
                <div key={index} className="flex items-center justify-between p-6 bg-gray-50 dark:bg-gray-700 rounded-xl">
                  ...
                  <div className="flex items-center gap-8">
                    <div className="text-right">
                      <p className="text-sm font-medium text-gray-900 dark:text-white">{service.uptime}% uptime</p>
                      <p className="text-xs text-gray-500 dark:text-gray-400">Last 30 days</p>
                    </div>
                    <div className="text-right">
                      <p className="text-sm font-medium text-gray-900 dark:text-white">{service.responseTime}ms</p>
      ...
      <section className="py-20 bg-white dark:bg-gray-800">
        <div className="max-w-6xl mx-auto px-6">
          <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-12 text-center">Performance Overview</h2>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="text-center p-6 bg-gray-50 dark:bg-gray-700 rounded-2xl">
              ...
              <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-2">99.96%</h3>
            ...
            <div className="text-center p-6 bg-gray-50 dark:bg-gray-700 rounded-2xl">
              ...
              <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-2">164ms</h3>
              <p className="text-gray-600 dark:text-gray-300">Avg Response Time</p>
              <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">Global average</p>
            </div>
            ...
            <div className="text-center p-6 bg-gray-50 dark:bg-gray-700 rounded-2xl">
              ...
              <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">CDN endpoints</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-20">
        <div className="max-w-6xl mx-auto px-6">
          <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-12 text-center">Recent Incidents</h2>
          
          {incidents.length === 0 ? (
            <div className="text-center py-12 bg-white dark:bg-gray-800 rounded-2xl">
              <CheckCircle className="w-16 h-16 text-green-500 mx-auto mb-4" />
              <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-2">No Recent Incidents</h3>
              <p className="text-gray-600 dark:text-gray-300">All systems have been running smoothly.</p>
            </div>
          ) : (
            <div className="space-y-6">
              {incidents.map((incident) => (
                <div key={incident.id} className="bg-white dark:bg-gray-800 rounded-2xl p-8 shadow-lg">
                  <div className="flex items-start justify-between mb-6">
                    <div>
                      ...
                      <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-2">{incident.title}</h3>
                    ...
                    <div className="text-right text-sm text-gray-500 dark:text-gray-400">
                      ...
                      {incident.resolvedTime && (
                        <p>Resolved: {new Date(incident.resolvedTime).toLocaleString()}</p>
                      )}
                    </div>
                  </div>
                  ...
                  <div className="space-y-4">
                    ...
                    {incident.updates.map((update, updateIndex) => (
                      <div key={updateIndex} className="flex gap-4 p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
                        <div className="text-sm text-gray-500 dark:text-gray-400 whitespace-nowrap">
                          {new Date(update.time).toLocaleString()}
                        </div>
                        <div className="flex-1">
                          <div className="flex items-center gap-2 mb-1">
                            <span className={`px-2 py-1 rounded text-xs font-medium ${getIncidentStatusColor(update.status)}`}>
      ...
      <section className="py-20 bg-makrx-blue dark:bg-gray-800">
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <p className="text-xl text-white/90 mb-8">
            Subscribe to get real-time notifications about service status and planned maintenance.
          </p>
