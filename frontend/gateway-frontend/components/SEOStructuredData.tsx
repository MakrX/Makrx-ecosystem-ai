        ...
        switch (type) {
            case 'organization':
                return {
                    ...
                    description:
                        "India's largest maker ecosystem providing access to makerspaces, tools, and learning resources",
                    address: {
                        '@type': 'PostalAddress',
                        addressCountry: 'IN',
            ...
            case 'website':
                return {
                    ...
                    url: 'https://makrx.org',
                    description:
                        "Access world-class makerspaces, shop cutting-edge tools, and learn new skills. Join India's largest maker ecosystem.",
                    publisher: {
                        '@type': 'Organization',
            ...
            case 'product':
                return {
                    ...
                    description:
                        'Comprehensive maker ecosystem including makerspaces, tools, and learning platform',
                    brand: {
                        '@type': 'Brand',
                        name: 'MakrX',
                    },
